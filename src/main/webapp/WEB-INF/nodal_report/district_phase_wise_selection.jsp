...
<head>
    ...
    <title>ITI Admissions | Phase-Wise Abstract</title>
...
<body class="nodal-body">
    ...
    <div class="nodal-page-title-dashboard">
        <h2>Industrial Training Institute — Phase Abstract</h2>
    </div>

    <div class="container">
        <div class="nodal-selection-container">
            <div class="nodal-selection-header">
                <h2>Phase-Wise Abstract</h2>
            </div>

            <form action="${pageContext.request.contextPath}/nodal-report/reports/phase-wise" method="post" id="phaseForm">
                <div class="mb-4">
                    <label for="year" class="form-label">SELECT ADMISSION YEAR</label>
                ...
                <div class="mt-5">
                    <button type="submit" class="nodal-btn-primary">
                        VIEW PHASE WISE REPORT
                    </button>
                </div>
            </form>
        </div>
