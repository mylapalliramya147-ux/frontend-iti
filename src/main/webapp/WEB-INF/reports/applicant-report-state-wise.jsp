...
<head>
    ...
    <title>Applicant by District | Nodal Reports</title>
...
<body class="nodal-body">
    ...
    <div class="nodal-page-title-dashboard"><h2>Applicant Report - State Level (Nodal)</h2></div>
    ...
    <div class="container-fluid px-4 py-4" id="reportView" style="display: none;">
        <div class="text-center mb-3" style="color: #003366;"><h2 class="fw-bold fs-4 mb-2" id="reportTitle">Applicant Report - State Level</h2></div>
    ...
    <script>
        ...
        function fetchReport(event) {
            ...
            .then(data => {
                ...
                document.getElementById('reportTitle').innerText = 'Applicant Report - State Level (' + year + ')';
