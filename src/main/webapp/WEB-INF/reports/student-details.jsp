...
<head>
    ...
    <style>
        ...
        .form-control-official { border: 1px solid #ced4da; border-radius: 6px; padding: 10px 15px; font-size: 1.05rem; color: #2d3748; background-color: #ffffff; transition: border-color 0.2s ease; width: 100%; }
        .form-control-official:focus { border-color: #003366; outline: none; box-shadow: 0 0 0 3px rgba(0, 51, 102, 0.1); }
...
<body class="nodal-body">
            ...
            <div class="p-5 bg-white rounded-bottom">
                <form id="reportForm" onsubmit="fetchReport(event)">
                    <div class="row align-items-center mb-4">
                        <div class="col-md-5"><label for="regid" class="form-label-official mb-md-0">Registration ID</label></div>
                        <div class="col-md-7"><input type="text" name="regid" id="regid" class="form-control-official" placeholder="Enter Registration ID"></div>
                    </div>
                    <div class="row align-items-center mb-4">
                        <div class="col-md-5"><label for="admNum" class="form-label-official mb-md-0">Admission Number</label></div>
                        <div class="col-md-7"><input type="text" name="admNum" id="admNum" class="form-control-official" placeholder="Enter Admission Number"></div>
                    </div>
    ...
    <script>
        ...
        function fetchReport(event) {
            ...
            if (!regid && !admNum) { alert('Please enter Registration ID or Admission Number'); return; }
            document.getElementById('selectionView').style.display = 'none';
            document.getElementById('loader').style.display = 'block';
            let params = '';
            if (regid) params += 'regid=' + encodeURIComponent(regid);
            if (admNum) params += (params ? '&' : '') + 'admNum=' + encodeURIComponent(admNum);
