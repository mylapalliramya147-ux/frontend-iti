            ...
            .then(data => {
                ...
                if (data.data && data.data.length > 0) {
                    ...
                    data.data.forEach(row => {
                        ...
                        totals.pending_sid += row.pendingSid || 0;
                        totals.verified += row.verified || 0;
                        totals.to_be_verified += row.toBeVerified || 0;
                        totals.to_be_updated += row.toBeUpdated || 0;
                        totals.phone_duplicate_records += row.phoneDuplicateRecords || 0;
                        totals.aadhar_duplicate_records += row.aadharDuplicateRecords || 0;
