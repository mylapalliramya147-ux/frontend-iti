...
<head>
    ...
    <title>Strength & Filled Seats | State Reports</title>
...
<body class="nodal-body">
    ...
    <c:set var="activeTab" value="strength_filled" />
    <%@ include file="../state_navbar.jsp" %>
    <div class="nodal-page-title-dashboard"><h2>DistWise Admitted Seats Abstract</h2></div>
    ...
    <script>
        ...
        function fetchReport(event) {
            ...
            .then(data => {
                ...
                document.getElementById('reportTitle').innerText = 'Strength & Filled Seats Report (' + year + ')';
