    ...
    <script>
        ...
        function fetchReport(event) {
            ...
            .then(data => {
                ...
                document.getElementById('reportTitle').innerText = 'Duration Wise Trade Seats Abstract (' + year + ')';
                ...
                if (data.data && data.data.length > 0) {
                    data.data.forEach(row => {
                        ...
                        tr.innerHTML = '<td>' + (row.tradeCode || '-') + '</td><td style="text-align: left;">' + (row.tradeName || '-') + '</td><td class="num">' + (row.strength || 0) + '</td><td class="num text-primary">' + (row.fill || 0) + '</td><td class="num text-success">' + (row.vacant || 0) + '</td><td class="num">' + (row.fillPercentage || 0) + '%</td>';
                    ...
                    ft.innerHTML = '<td colspan="2" style="text-align: right; padding-right: 30px; font-weight: bold;">GRAND TOTAL</td><td class="num">' + totals.strength + '</td><td class="num">' + totals.fill + '</td><td class="num">' + totals.vacant + '</td><td class="num">-</td>';
