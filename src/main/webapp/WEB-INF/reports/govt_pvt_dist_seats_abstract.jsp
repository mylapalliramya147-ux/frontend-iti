...
<head>
    ...
    <title>Govt/Pvt Seats Abstract | Nodal Reports</title>
...
<body class="nodal-body">
    ...
    <c:set var="activeTab" value="govt_pvt" />
    <%@ include file="../nodal_navbar.jsp" %>
    <div class="nodal-page-title-dashboard"><h2>Govt or Pvt Dist Wise Seats Abstract</h2></div>
    ...
    <script>
        ...
        function fetchReport(event) {
            ...
            .then(data => {
                ...
                document.getElementById('reportTitle').innerText = 'Govt./Pvt. ITI Seats Abstract (' + year + ')';
