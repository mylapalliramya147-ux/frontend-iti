...
<head>
    ...
    <title>District Dashboard | Nodal Reports</title>
...
<body class="nodal-body">
                ...
                <table class="table table-bordered mb-0 table-hover text-center report-table" id="tot" style="min-width: 1000px;">
                    <thead>
                        <tr>
                            <th>slno</th>
                            <th>ITI Code</th>
                            <th style="text-align: left;">ITI Name</th>
                            <th>Total</th>
                            <th>Success</th>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const distCode = urlParams.get('distCode') || '${param.distCode}';
            if (!distCode) {
                alert('District code is required.');
                return;
            }
        ...
        function loadReport(year, distCode) {
            ...
            .then(response => {
                ...
                ft.innerHTML = '<td colspan="3" style="text-align: right; padding-right: 20px;">Total</td>' +
