...
<head>
    ...
    <title>Admission Report | Trade-wise</title>
...
<body class="nodal-body">
    ...
    <div class="container-fluid px-4 py-4" id="reportView" style="display: none;">
        <div class="text-center mb-3" style="color: #003366;"><h2 class="fw-bold fs-4 mb-2" id="reportTitle">Trade-wise Admission Report</h2></div>
    ...
    <script>
        ...
        function fetchReport(event) {
            ...
            .then(data => {
                ...
                document.getElementById('reportTitle').innerText = 'Trade-wise Admission Report (' + year + ')';
