    ...
    <ul id="menu-bar">
        ...
        <li><a href="#">ITI Reports</a>
            <ul>
                ...
                <li><a href="${pageContext.request.contextPath}/jsp/AdmissionsReport3.jsp">Admissions Report</a></li>
                <li><a href="${pageContext.request.contextPath}/reports/nodal-report/dashboard">State Dashboard</a></li>
            </ul>
        </li>
        <li><a href="#">Admissions</a>
            <ul>
                <li><a href="${pageContext.request.contextPath}/jsp/permitted_shift_unit_nodal_report.jsp">DGT Permitted Shifts Report</a></li>
                <li><a href="${pageContext.request.contextPath}/VerificationReport">Verification Report</a></li>
            </ul>
        </li>
