...
<head>
    ...
    <title>Caste-wise Admissions Report | District</title>
        ...
        <div class="shadow" style="background-color: #fff; border-radius: 8px; overflow: hidden; border: 1px solid #e0e0e0;">
            <div style="overflow-y: auto; max-height: 600px;">
                <table class="table table-bordered mb-0 table-hover text-center report-table" id="statusTable" style="min-width: 1000px;">
                    <thead><tr><th>District Code</th><th>District Name</th><th class="num">BC-A</th><th class="num">BC-B</th><th class="num">BC-C</th><th class="num">BC-D</th><th class="num">BC-E</th><th class="num">EWS</th><th class="num">EX-S</th><th class="num">IM</th><th class="num">OC</th><th class="num">PH</th><th class="num">SC-I</th><th class="num">SC-II</th><th class="num">SC-III</th><th class="num">SP</th><th class="num">ST</th></tr></thead>
    ...
    <script>
        ...
        function fetchReport(event) {
            ...
            .then(data => {
                ...
                } else { tbody.innerHTML = '<tr><td colspan="17" style="text-align:center; padding:20px; font-weight: bold;">No records found.</td></tr>'; }
            })
