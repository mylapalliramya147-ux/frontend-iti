...
$("#inplantcard").append('1. ' + link('In-Plant Training Entry', '${pageContext.request.contextPath}/implant/entry'));
$("#inplantcard").append('2. ' + link('ITI - Industry Mapping Entry', '${pageContext.request.contextPath}/implant/mapping'));
$("#inplantcard").append('<h6 class="card-title text-success mt-2">Reports</h6>');
$("#inplantcard").append('3. ' + link('In-Plant Report', '${pageContext.request.contextPath}/implant/report'));
$("#plcmtscard").empty();
$("#plcmtscard").append('<h4 class="card-title text-danger">PLACEMENTS</h4>');
$("#plcmtscard").append('<h6 class="card-title text-success">Services</h6>');
...
$("#inplantcard").append('4. ' + link('Industry Partner Details', '${pageContext.request.contextPath}/implant/partners'));
$("#inplantcard").append('<h6 class="card-title text-success mt-2">Reports</h6>');
