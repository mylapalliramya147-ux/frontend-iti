...
(function($) {
    ...
    $.extend(Datepicker.prototype, {
        ...
        _attachPlugin: function(b, c) {
            ...
            var e = {
                ...
                get: function(a) {
                    if ($.inArray(a, ['defaultDate', 'minDate', 'maxDate']) > -1) {
                        return F.determineDate(this.options[a], null, this.selectedDates[0], this.options.dateFormat, e.getConfig());
                    }
            ...
            if (e.inline) {
                e.drawDate = F._checkMinMax(F.newDate(e.selectedDates[0] || e.get('defaultDate') || F.today()), e);
                ...
                b.bind('keydown.' + this.propertyName, this._keyDown).bind('keypress.' + this.propertyName, this._keyPress).bind('keyup.' + this.propertyName, this._keyUp);
                if (b.attr('disabled')) {
        ...
        _optionPlugin: function(b, c, d) {
            ...
            e.drawDate = F.newDate(this._checkMinMax((e.options.defaultDate ? e.get('defaultDate') : e.drawDate) || e.get('defaultDate') || F.today(), e));
            if (!e.inline) {
                this._attachments(b, e);
            }
            if (e.inline || e.div) {
        ...
        _destroyPlugin: function(a) {
            ...
            a.removeClass(this.markerClassName).removeData(this.propertyName).empty().unbind('.' + this.propertyName);
        ...
        _enablePlugin: function(b) {
            ...
            if (c.inline) {
                b.children('.' + this._disableClass).remove().end().find('button,select').removeAttr('disabled').end().find('a').attr('href', 'javascript:void(0)');
            } else {
                b.prop('disabled', false);
                c.trigger.filter('button.' + this._triggerClass).removeAttr('disabled').end().filter('img.' + this._triggerClass).css({
                    opacity: '1.0',
                    cursor: ''
                });
            }
        ...
        _disablePlugin: function(b) {
            ...
            if (c.inline) {
                ...
                b.prepend('<div class="' + this._disableClass + '" style="' + 'width: ' + d.outerWidth() + 'px; height: ' + d.outerHeight() + 'px; left: ' + (e.left - f.left) + 'px; top: ' + (e.top - f.top) + 'px; z-index: ' + g + '"></div>').find('button,select').attr('disabled', 'disabled').end().find('a').removeAttr('href');
            } else {
                b.prop('disabled', true);
                c.trigger.filter('button.' + this._triggerClass).attr('disabled', 'disabled').end().filter('img.' + this._triggerClass).css({
                    opacity: '0.5',
                    cursor: 'default'
                });
            }
        ...
        _checkExternalClick: function(a) {
            ...
            var b = $(a.target);
            if (!b.parents().andSelf().hasClass(F._popupClass) && !b.hasClass(F.markerClassName) && !b.parents().andSelf().hasClass(F._triggerClass)) {
        ...
        _keyDown: function(a) {
            ...
            if (c.div) {
                if (a.keyCode == 9) {
                    ...
                    F._selectDatePlugin(b, $('a.' + c.options.renderer.highlightedClass, c.div)[0]);
                    d = true;
                } else {
        ...
        _doMouseWheel: function(a, b) {
            var c = (F.curInst && F.curInst.target[0]) || $(a.target).closest('.' + F.markerClassName)[0];
            ...
            if (d.options.useMouseWheel) {
                b = (b < 0 ? -1 : +1);
                F._changeMonthPlugin(c, -d.options[a.ctrlKey ? 'monthsToJump' : 'monthsToStep'] * b);
            }
            a.preventDefault();
        },
        ...
        _changeDayPlugin: function(a, b) {
            ...
            if (c) {
                ...
                this._showMonthPlugin(a, d.getFullYear(), d.getMonth() + 1, d.getDate());
            }
        },
        ...
        _generateContent: function(h, i) {
            ...
            p.find(i.options.renderer.daySelector + ' a').hover(function() {
                ...
                (i.inline ? $(this).parents('.' + t.markerClassName) : i.div).find(i.options.renderer.daySelector + ' a').removeClass(i.options.renderer.highlightedClass);
            }).click(function() {
                ...
                try {
                    ...
                    t._showMonthPlugin(h, a, i.drawDate.getMonth() + 1, i.drawDate.getDate());
                } catch (e) {
                    alert(e);
                }
            }).keydown(function(a) {
        ...
        _generateMonthSelection: function(a, b, c, d, e, f) {
            ...
            var i = '<select class="' + this._monthYearClass + '" title="' + a.options.monthStatus + '">';
            for (var m = 1; m <= 12; m++) {
                if ((!d || F.newDate(b, m, F.daysInMonth(b, m)).getTime() >= d.getTime()) && (!e || F.newDate(b, m, 1).getTime() <= e.getTime())) {
            ...
            if (j == 'any') {
                i = '<select class="' + this._monthYearClass + ' ' + this._anyYearClass + '" title="' + a.options.yearStatus + '">' + '<option>' + b + '</option></select>' + '<input class="' + this._monthYearClass + ' ' + this._curMonthClass + c + '" value="' + b + '">';
            } else {
                j = j.split(':');
                ...
                i = '<select class="' + this._monthYearClass + '" title="' + a.options.yearStatus + '">';
    ...
    $(function() {
        $(document).mousedown(F._checkExternalClick).resize(function() {
            F._hidePlugin(F.curInst)
        })
    })
})(jQuery);
