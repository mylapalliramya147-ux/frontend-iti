...
<head>
    ...
    <title>ITI Admissions | API Dashboard</title>
...
<body class="nodal-body">
    ...
    <div class="nodal-page-title-dashboard">
        <h2>Industrial Training Institute — API Performance Dashboard</h2>
    </div>

    <div class="container mt-4">
        <div class="nodal-report-card shadow-lg mx-auto" style="max-width: 650px;">
            <div class="nodal-card-header-dashboard">
                <i class="fas fa-chart-line me-2"></i> Dashboard Selection Criteria
            </div>
            <div class="p-5 bg-white rounded-bottom">
                <form action="${pageContext.request.contextPath}/nodal-report/reports/dashboard" method="post" id="dashboardForm">
                    <div class="mb-4">
                    ...
                    <div class="mt-5 text-center">
                        <button type="submit" class="nodal-btn-primary w-100 py-3" style="border-radius: 10px; font-weight: 600; letter-spacing: 1px;">
                            <i class="fas fa-search me-2"></i> VIEW DASHBOARD REPORT
                        </button>
                        <p class="text-muted small mt-4">
                            <i class="fas fa-info-circle me-1"></i> Data integrated from the Unified Node.js API
                        </p>
                    </div>
                </form>
            </div>
    ...
    <script>
        ...
        async function fetchJSON(url) {
            try {
                ...
                return { years: ["2024", "2025"] }; // Fallback
            }
        }
